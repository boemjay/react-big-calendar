...
var EventContainerWrapper =
  ...
  (function(_React$Component) {
    ...
    _proto.update = function update(event, _ref2, additionalEvents) {
    ...
    _proto.render = function render() {
      ...
      var _this$state = this.state,
        ...
        additionalDragPreviews = _this$state.additionalDragPreviews
          ...
          function(isWeek) {
            return _react.default.createElement(
              ...
              isWeek &&
                ...
                additionalDragPreviews.map(function(e, idx) {
                  var startsBeforeDay = slotMetrics.startsBeforeDay(e.startDate)
                  var startsAfterDay = slotMetrics.startsAfterDay(e.endDate)
                  if (startsBeforeDay) format = 'eventTimeRangeEndFormat'
                  else if (startsAfterDay) format = 'eventTimeRangeStartFormat'
