!(function(e, t) {
  ...
  var jr,
    ...
    Cr = (jr = /[^.]+$/.exec((Nr && Nr.keys && Nr.keys.IE_PROTO) || ''))
      ? 'Symbol(src)_1.' + jr
      : ''
  var Rr = Function.prototype.toString
  function kr(e) {
    if (null != e) {
      try {
        return Rr.call(e)
  ...
  function Wr(e) {
    return (
      !(!Le(e) || ((t = e), Cr && Cr in t)) && (Ue(e) ? zr : Ar).test(kr(e))
    )
    var t
  }
  function Hr(e, t) {
  ...
  function ki(e, t) {
    ...
    return (n.cache = new (ki.Cache || Kr)()), n
  }
  ki.Cache = Kr
  var Ai = 500
  var Pi,
        ...
        getRanges: function(e, o, i, a) {
          ...
          for (var u = 0; u < l; u++) {
            ...
            c.push({
              ...
              height: (h / (r * f)) * 100 - v,
              start: 0,
              startDate: $(d, -1, 'seconds'),
              end: b(p),
              endDate: p,
              xOffset: 100 * u,
            })
          }
          return c.length > 1 ? c.slice(1) : null
        },
    ...
    function t(t) {
      ...
      return (
        ...
        (o.handleResize = function() {
          kt(o.rafHandle), (o.rafHandle = At(o.checkOverflow))
        }),
      ...
      return (
        ...
        (t.prototype.render = function() {
          ...
          return r.createElement(
            ps.Provider,
            { value: !0 },
            r.createElement(fs, a({}, o, { range: i, eventOffset: 15 }))
          )
        }),
        t
      )
  ...
  function ms(e, t) {
    return hs.range(e, t).filter(function(e) {
      return -1 === [6, 0].indexOf(e.getDay())
    })
  }
  ;(hs.propTypes = {}),
    (hs.defaultProps = fs.defaultProps),
    ...
    return (
      ...
      (t.prototype.render = function() {
        ...
        return r.createElement(
          ps.Provider,
          { value: !0 },
          r.createElement(fs, a({}, n, { range: o, eventOffset: 15 }))
        )
      }),
      t
    )
  ...
  ;(bs.propTypes = {}),
    ...
    (bs.range = function(e, t) {
      ...
      return {
        start: e,
        end: $(e, void 0 === n ? bs.defaultProps.length : n, 'day'),
      }
    }),
    (bs.navigate = function(e, t, n) {
      var r = n.length,
        o = void 0 === r ? bs.defaultProps.length : r
      switch (t) {
        case x.PREVIOUS:
          return $(e, -o, 'day')
        case x.NEXT:
    ...
    (bs.title = function(e, t) {
      var n = t.length,
        r = void 0 === n ? bs.defaultProps.length : n,
        o = t.localizer,
        i = $(e, r, 'day')
      return o.format({ start: e, end: i }, 'agendaHeaderFormat')
    })
  var ws = (((ys = {})[T.MONTH] = Da),
  (ys[T.WEEK] = hs),
  (ys[T.WORK_WEEK] = vs),
  (ys[T.DAY] = ds),
  (ys[T.AGENDA] = bs),
  ...
  function Es(e, t) {
    ...
    switch (((e = 'string' == typeof e ? ws[e] : e), n)) {
      case x.TODAY:
        r = o || new Date()
        break
      case x.DATE:
  ...
  function Ds(e, t, n) {
    var r = e[t]
    ;(Ss.call(e, t) && Oe(r, n) && (void 0 !== n || t in e)) || Ms(e, t, n)
  }
  function xs(e, t, n, r) {
    var o = !n
    n || (n = {})
    for (var i = -1, a = t.length; ++i < a; ) {
      ...
      void 0 === c && (c = e[s]), o ? Ms(n, s, c) : Ds(n, s, c)
    }
    return n
  }
  ...
  function js(e) {
    ...
    var t = Jo(e),
      n = []
    for (var r in e) ('constructor' != r || (!t && Ts.call(e, r))) && n.push(r)
    return n
  }
  function Ns(e) {
    return Be(e) ? Ko(e, !0) : js(e)
  }
  var Cs = 'object' == typeof e && e && !e.nodeType && e,
    Rs =
      Cs && 'object' == typeof module && module && !module.nodeType && module,
    ks = Rs && Rs.exports === Cs ? De.Buffer : void 0,
    As = ks ? ks.allocUnsafe : void 0
  var Ps = Qo(Object.getPrototypeOf, Object),
    Fs = Object.getOwnPropertySymbols
      ? function(e) {
          for (var t = []; e; ) Mo(t, No(e)), (e = Ps(e))
          return t
        }
      : xo
  function Ls(e) {
  ...
  var Ws = /\w*$/
  var Hs = xe ? xe.prototype : void 0,
    Us = Hs ? Hs.valueOf : void 0
  ...
  function cc(e, t, n) {
    ...
    switch (t) {
      ...
      case Gs:
        return (
          ((i = new (o = e).constructor(o.source, Ws.exec(o))).lastIndex =
            o.lastIndex),
          i
        )
      case Xs:
  ...
  function Sc(e, t, n, r, o, i) {
    ...
    return (
      Os(m || e, function(r, o) {
        m && (r = e[(o = r)]), Ds(a, o, Sc(r, t, n, o, e, i))
      }),
      a
    )
  }
  ...
  ;(Mc[wc] = Mc['[object Array]'] = Mc['[object ArrayBuffer]'] = Mc[
    '[object DataView]'
  ...
  var Pc = (function(e) {
      ...
      ;(t = Hi(t, function(t) {
        ...
        xs(e, Ls(e), n),
        r && (n = Sc(n, 7, kc))
      for (var o = t.length; o--; ) Dc(n, t[o])
      return n
    }),
    Fc = Object.prototype,
    Lc = Fc.hasOwnProperty,
    Ic = Ga(function(e, t) {
      e = Object(e)
      var n = -1,
        r = t.length,
      ...
      for (o && qe(t[0], t[1], o) && (r = 1); ++n < r; )
        for (var i = t[n], a = Ns(i), s = -1, c = a.length; ++s < c; ) {
          var l = a[s],
            u = e[l]
          ;(void 0 === u || (Oe(u, Fc[l]) && !Lc.call(e, l))) && (e[l] = i[l])
        }
      return e
    })
  var zc = function(e) {
      ...
      return (
          ...
          return Array.isArray(o)
            ? (function(e, t, n) {
                ...
                if (((t = ra(t)), null == n)) {
                  ...
                  n = o ? (r ? new i() : []) : Le(e) && Ue(i) ? uc(Ps(e)) : {}
                }
                return (
                  (o ? Os : Pa)(e, function(e, r, o) {
                    return t(n, e, r, o)
                  }),
                  n
                )
        ...
        (t.handleNavigate = function(e, n) {
          var r = t.props,
            ...
            d = c()
          l(
            (i = Es(f, a({}, u, { action: e, date: n || i || d, today: d }))),
            o,
            e
          ),
  ...
  var Uc = (function e(t, n, o) {
    ...
    })(Hc, { view: 'onView', date: 'onNavigate', selected: 'onSelectEvent' }),
    Vc = function(e, t, n) {
      var r = e.start,
        o = e.end
  ...
  var Kc = function(e, t, n) {
    ...
    Jc = { eventWrapper: i, timeSlotWrapper: i, dateCellWrapper: i }
  ;(e.Calendar = Uc),
    (e.DateLocalizer = R),
    (e.Navigate = x),
    (e.Views = T),
